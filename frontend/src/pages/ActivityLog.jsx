...
const ACTION_META = {
  ...
  "teacher.discipline_role_changed": { label: "Teacher SBMS role changed", icon: UserCog, tone: "text-brand-600 bg-brand-50" },
  "discipline.created": { label: "Discipline staff added", icon: UserPlus, tone: "text-emerald-600 bg-emerald-50" },
  "discipline.updated": { label: "Discipline staff updated", icon: UserCog2, tone: "text-brand-600 bg-brand-50" },
  "discipline.deleted": { label: "Discipline staff deleted", icon: UserMinus, tone: "text-rose-600 bg-rose-50" },
  "discipline.activated": { label: "Discipline staff activated", icon: ShieldCheck, tone: "text-emerald-600 bg-emerald-50" },
  "discipline.deactivated": { label: "Discipline staff deactivated", icon: ShieldOff, tone: "text-amber-600 bg-amber-50" },
  "discipline.password_reset": { label: "Discipline staff password reset", icon: KeyRound, tone: "text-brand-600 bg-brand-50" },
...
const ROLE_ACTIONS = {
  manager: [
    ...
    "teacher.discipline_role_changed",
    "discipline.created",
    "discipline.updated",
    "discipline.deleted",
    "discipline.activated",
    "discipline.deactivated",
    "discipline.password_reset",
